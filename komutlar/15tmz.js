...
exports.run = function (client, message, args) {
    ...
    if(!value) {
	    message.reply("https://yunti.files.wordpress.com/2018/07/15temmuz_03_tam35-blogspot-com.gif")
    }		
    if (!message.member.voiceChannel) return message.reply("**https://yunti.files.wordpress.com/2018/07/15temmuz_03_tam35-blogspot-com.gif**");
		    if (value === "çal") {
